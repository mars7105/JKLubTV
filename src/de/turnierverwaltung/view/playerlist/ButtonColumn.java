...
public class ButtonColumn extends AbstractCellEditor
	...
	private final ImageIcon userEdit = new ImageIcon(
	 ...
	 * @param deleteAction
	 * @param column
	 *                         the column to which the button renderer/editor is
	 *                         added
	 */
	public ButtonColumn(final JTable table, final Action action, final Action deleteAction, final int column1,
			final int column2) {
		this.table = table;
		this.action = action;
	...
	public Component getTableCellEditorComponent(final JTable table, final Object value, final boolean isSelected,
		...
		if (value == null) {
			...
			if (value.toString().equals("Delete")) {
				editButton.setIcon(userDelete);
			} else {
				editButton.setIcon(userEdit);
			}
