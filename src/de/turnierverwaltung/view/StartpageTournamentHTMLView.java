...
public class StartpageTournamentHTMLView extends JPanel {
	/**
	 * 
	 */
	...
	public StartpageTournamentHTMLView() {
		language = Locale.getDefault().getLanguage();
		// setBackground(titleColor);
		// setForeground(titleTextColor);
		ContextMenuMouseListener cmmL = new ContextMenuMouseListener();
		java.net.URL helpURL = getClass().getResource("/files/startpagetournament.html");
		if (language.equals(new Locale("de").getLanguage())) {
			helpURL = getClass().getResource("/files/startpagetournament.html");
		} else if (language.equals(new Locale("en").getLanguage())) {
			helpURL = getClass().getResource("/files/startpagetournament_en.html");
		}
