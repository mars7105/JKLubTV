...
public class SimpleTerminTabelle extends DefaultTableModel {
	/**
	 * 
	 */
	...
	public SimpleTerminTabelle(TerminTabelle terminTabelle) {
		super();
	...
	public boolean isCellEditable(int rowIndex, int columnIndex) {
		...
		if (this.getValueAt(rowIndex, 1) == "Spielfrei" || this.getValueAt(rowIndex, 2) == "Spielfrei") {
			icE = false;
		}
