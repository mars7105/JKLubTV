...
public class PaarungsTafeln {
	...
	public PaarungsTafeln(Gruppe gruppe) {
		this.gruppe = gruppe;
		initValues();
		createPaarungsTafel();
		createPartien();
	...
	private void createPartien() {
		...
		for (int i = 0; i < rundenAnzahl; i++) {
			...
			for (int y = 0; y < paarungsFormel.length; y++) {
				...
				partien[partienNummer] = new Partie();
	...
	public void initValues() {
		...
		this.partien = new Partie[partienAnzahl];
	}
	...
	public void setPartien(Partie[] partien) {
