...
public class TurnierTabelleToHTML {
	...
	public TurnierTabelleToHTML(String[][] tabellenMatrix, Turnier turnier, String gruppenName, String infoString) {
				...
				if (ausgabeWert != null && ausgabeWert != "" //$NON-NLS-1$
					...
					if (y == 0) {
						htmlString += "        <th>" //$NON-NLS-1$
								+ TurnierKonstanten.HTML_LEERZEICHEN + "</th>\n"; //$NON-NLS-1$
					} else {
						htmlString += "        <td>" //$NON-NLS-1$
								+ TurnierKonstanten.HTML_LEERZEICHEN + "</td>\n"; //$NON-NLS-1$
					}
				}
