...
public class TerminTabelleControl {
	...
	public void makeSimpleTableView(int gruppenNummer) {
		...
		if (tabAnzeigeView2[gruppenNummer].getTabCount() == 1) {
			tabAnzeigeView2[gruppenNummer].insertTab("Termintabelle", null, simpleTableView[gruppenNummer], null, 1);
		} else {

			tabAnzeigeView2[gruppenNummer].setComponentAt(1, simpleTableView[gruppenNummer]);
		}
