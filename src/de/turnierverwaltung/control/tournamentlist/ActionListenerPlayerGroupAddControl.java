...
public class ActionListenerPlayerGroupAddControl implements ActionListener {
	...
	// editTournamentView =
	// this.mainControl.getActionListenerTournamentItemsControl().getTurnierEditierenView();
	...
	public void actionPerformed(final ActionEvent arg0) {
		...
		// Messages.getString("ActionListenerPlayerGroupAddControl.1"),
		// Messages.getString("ActionListenerPlayerGroupAddControl.0"),
		...
		//
		// }
		// mainControl.setNewTournamentGroupsControl(new
		// NewTournamentGroupsControl(mainControl));
		//
