...
public class MySQLDAOFactory extends DAOFactory {
	...
	private static int databaseDriver;
	...
	public static void setDB_PATH(String dbPath) {
		MySQLDAOFactory.DB_PATH = dbPath;
		MySQLDAOFactory.dbStringSQLite = "jdbc:sqlite:" + DB_PATH;

	}

	public MySQLDAOFactory(int databaseDriver) {
		MySQLDAOFactory.databaseDriver = databaseDriver;
